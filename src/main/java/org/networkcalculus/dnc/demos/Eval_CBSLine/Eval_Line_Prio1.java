...
public class Eval_Line_Prio1 {
    ...
    public void run() throws Exception {
        ...
        servers[0] = sg.addServer("S1", Curve.getFactory().createRateLatency(5.0E7, 1.6704E-4), AnalysisConfig.Multiplexing.FIFO);
        servers[1] = sg.addServer("S2", Curve.getFactory().createRateLatency(5.0E7, 1.6704E-4), AnalysisConfig.Multiplexing.FIFO);
        servers[2] = sg.addServer("S3", Curve.getFactory().createRateLatency(5.0E7, 1.6704E-4), AnalysisConfig.Multiplexing.FIFO);
        servers[3] = sg.addServer("S4", Curve.getFactory().createRateLatency(5.0E7, 1.6704E-4), AnalysisConfig.Multiplexing.FIFO);
        servers[4] = sg.addServer("S5", Curve.getFactory().createRateLatency(5.0E7, 1.6704E-4), AnalysisConfig.Multiplexing.FIFO);
        servers[5] = sg.addServer("S6", Curve.getFactory().createRateLatency(5.0E7, 1.2E-4), AnalysisConfig.Multiplexing.FIFO);
