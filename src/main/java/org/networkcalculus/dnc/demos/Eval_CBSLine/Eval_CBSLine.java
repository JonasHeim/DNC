...
public class Eval_CBSLine {
    ...
    public void run() throws Exception {
        ...
        /* Priority 1 - Class B */
        CBS_Flow flow0 = new CBS_Flow("flow0", 5e-4, 1208*8, 2, 1,
                CBS_Flow.Periodicity.PERIODIC);

        /* Priority 0 - Class A */
        CBS_Flow flow1 = new CBS_Flow("flow1", 1.25e-4, 42*8, 2, 0,
                CBS_Flow.Periodicity.PERIODIC);
        CBS_Flow flow2 = new CBS_Flow("flow2", 1.25e-4, 42*8, 2, 0,
                CBS_Flow.Periodicity.PERIODIC);
        CBS_Flow flow3 = new CBS_Flow("flow3", 1.25e-4, 42*8, 2, 0,
                CBS_Flow.Periodicity.PERIODIC);
