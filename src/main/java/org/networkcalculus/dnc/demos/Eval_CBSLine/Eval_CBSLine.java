...
public class Eval_CBSLine {
    ...
    public void run() throws Exception {
        ...
        /* Priority 0 - Class A */
        CBS_Flow flow1 = new CBS_Flow("flow1", 1.25e-4, 1776, 2, 0,
                CBS_Flow.Periodicity.PERIODIC);
        CBS_Flow flow2 = new CBS_Flow("flow2", 1.25e-4, 1776, 2, 0,
                CBS_Flow.Periodicity.PERIODIC);
        CBS_Flow flow3 = new CBS_Flow("flow3", 1.25e-4, 1776, 2, 0,
                CBS_Flow.Periodicity.PERIODIC);
        CBS_Flow flow4 = new CBS_Flow("flow4", 1.25e-4, 1776, 2, 0,
                CBS_Flow.Periodicity.PERIODIC);
        CBS_Flow flow5 = new CBS_Flow("flow5", 1.25e-4, 1776, 2, 0,
                CBS_Flow.Periodicity.PERIODIC);
